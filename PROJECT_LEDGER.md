...
| Supabase/RLS/migraciones | Root + especialista de datos | Identidad Sumi y preflight remoto verificados; datos aptos para migración. Se cerró el riesgo `TRUNCATE` y pasan 16 invariantes; apply/postflight siguen pendientes | `supabase/migrations/**`, `supabase/config.toml`, `supabase/verification/**` | Aprobación inmediata de la escritura, apply transaccional y postflight |
