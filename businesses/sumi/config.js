...
const labels = {
  es: {
    ...
    authSignupCheckEmail: "Revisa tu correo para confirmar la cuenta.",
    authGenericError: "No pudimos completar la operacion. Intenta de nuevo.",
    authEmailDeliveryError: "No pudimos enviar el correo de confirmacion. Revisa la configuracion de emails e intenta de nuevo.",
    loyaltyGuestPrompt: "Inicia sesion para ver tus puntos.",
    loyaltyShowQrHint: "Muestra tu QR al empleado para acreditar tu consumo.",
    profileButtonLabel: "Abrir perfil",
    profileClose: "Cerrar perfil",
    profileKicker: "Mi cuenta",
    profileTitle: "Perfil de cliente",
    profilePointsLabel: "Puntos disponibles",
    profileAdminPanel: "Panel de admin",
    profileQr: "QR de cliente recurrente",
    profileHistory: "Historial de puntos",
    profileHistoryEmpty: "Todavia no hay movimientos.",
    profileLogout: "Cerrar sesion",
    profileLoggedOut: "Sesion cerrada",
  ...
  en: {
    ...
    authSignupCheckEmail: "Check your email to confirm your account.",
    authGenericError: "We could not complete the action. Try again.",
    authEmailDeliveryError: "We could not send the confirmation email. Check the email setup and try again.",
    loyaltyGuestPrompt: "Sign in to see your points.",
    loyaltyShowQrHint: "Show your QR to the team so they can add your visit.",
    profileButtonLabel: "Open profile",
    profileClose: "Close profile",
    profileKicker: "My account",
    profileTitle: "Customer profile",
    profilePointsLabel: "Available points",
    profileAdminPanel: "Admin panel",
    profileQr: "Returning customer QR",
    profileHistory: "Points history",
    profileHistoryEmpty: "No activity yet.",
    profileLogout: "Sign out",
    profileLoggedOut: "Signed out",
  ...
  ar: {
    ...
    authSignupCheckEmail: "راجع بريدك لتأكيد الحساب.",
    authGenericError: "تعذر إكمال العملية. حاول مرة أخرى.",
    authEmailDeliveryError: "تعذر إرسال رسالة التأكيد. تحقق من إعدادات البريد وحاول مرة أخرى.",
    loyaltyGuestPrompt: "سجل الدخول لرؤية نقاطك.",
    loyaltyShowQrHint: "اعرض QR للموظف لإضافة زيارتك.",
    profileButtonLabel: "فتح الملف الشخصي",
    profileClose: "إغلاق الملف الشخصي",
    profileKicker: "حسابي",
    profileTitle: "ملف العميل",
    profilePointsLabel: "النقاط المتاحة",
    profileQr: "QR العميل المتكرر",
    profileHistory: "سجل النقاط",
    profileHistoryEmpty: "لا توجد حركات بعد.",
    profileLogout: "تسجيل الخروج",
    profileLoggedOut: "تم تسجيل الخروج",
